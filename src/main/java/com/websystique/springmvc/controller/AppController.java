...
public class AppController
{
	 ...
	 */
	@RequestMapping(value =
	{ "/newuser" }, method = RequestMethod.POST)
	...
	@RequestMapping(value =
	{ "/add-document-{userId}" }, method = RequestMethod.GET)
	...
	@RequestMapping(value =
	{ "/download-document-{userId}-{docId}" }, method = RequestMethod.GET)
	...
	@RequestMapping(value =
	{ "/delete-document-{userId}-{docId}" }, method = RequestMethod.GET)
	...
	@RequestMapping(value =
	{ "/add-document-{userId}" }, method = RequestMethod.POST)
